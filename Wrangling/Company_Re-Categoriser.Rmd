...
def relevance(text):
  ...
  content = "You are a helpful assistent that when provided the name of an organisation finds out whether they are related to the hydrogen economy in the nordics or not. This can be one out of the four following categories: 'Direct', 'Partly', 'Indirect' or 'None'. The categories are defined as: 1. "+cat1+" 2. "+cat2+" 3. "+cat3+" 4. "+cat4+" You respond with one out of the four categories. Your response is in the form of a python list where each organisation has its own list."
  prompt = f"Classify the following companies: '{text}'"
...
dict_df = {'Name': col1, 'Hydrogen_relevance': col2}

...
---
## Introduction
This script is for categorising the companies. It uses open AI soft- and hardware via API in order to do so. The script should not overwrite previous saved entries but only add new for newly added companies.

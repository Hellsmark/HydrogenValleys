...
```
The dataframe may be too large for the AI-model to be able to provide a response for each company
Therefor should the following section be run multiple times with 100 companies each time until we have added it all to the df_done_py dataframe.
### Categorising all the companies
```{python}
i = 0
j = 0

...
map4 <- ggplot(map2_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 4: Innovation and Research -**<br>**Denmark and Norway** <br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot),
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
map3 <- ggplot(map3_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 3: Energy Utilities -**<br> **Capital Cities** <br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
map2 <- ggplot(map4_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 4: Industrial Engineering** <br> **and Consulting - Oslo area** <br>","(n jobs = ",
...
map6 <- ggplot(map5_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 6: Generic Engineering**<br> **and Research - All countries**<br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
map5 <- ggplot(map6_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 5: Across Industries -**<br> **Urban Areas** <br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",

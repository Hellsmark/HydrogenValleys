...
Cluster 2 in data = Cluster 4 in Paper
...
map4 <- ggplot(map2_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 4: Innovation and Research -**<br>**Denmark and Norway** <br>","(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot),
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
Cluster 3 in Data, Cluster 3 in paper
...
map3 <- ggplot(map3_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 3: Energy Utilities -**<br> **Capital Cities** <br>","(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
Cluster 4 in Data, Cluster 2 in paper
...
map2 <- ggplot(map4_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 2: Industrial Engineering** <br> **and Consulting - Oslo area** <br>","(n = ",
...
Cluster 5 in data, Cluster 6 in paper
...
map6 <- ggplot(map5_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 6: Generic Engineering**<br> **and Research - All countries**<br>","(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
Cluster 6 in data, figure 5 in paper
...
map5 <- ggplot(map6_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale +
  labs(tag = paste0("**Cluster 5: Across Industries -**<br> **Urban Areas** <br>","(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
map1e <- ggplot(map1_engineer, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale_engineering +
  labs(tag = paste0("**Cluster 1: Offshore & Energy**<br> **Technology - Norwegian south-west** <br>",
                    "(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all engineers)')) +
  theme(
...
map2e <- ggplot(map2_engineer, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale_engineering +
  labs(tag = paste0("**Cluster 2: Energy Technology -**<br> **Oslo & Rogaland** <br>",
                    "(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all engineers)')) +
  theme(
...
map4e <- ggplot(map3_engineer, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale_engineering +
  labs(tag = paste0("**Cluster 4: Technical Expertise -**<br> **Across Sectors & Regions** <br>",
                    "(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all engineers)')) +
  theme(
...
map3e <- ggplot(map4_engineer, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  shared_fill_scale_engineering +
  labs(tag = paste0("**Cluster 3: Energy Infrastructure**<br> **and Systems - Sweden** <br>",
                    "(n = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all engineers)')) +
  theme(
...
ggsave(filename = paste0("H2_paper/cluster_2025/engineers/k=4/",
       ...
       plot = combined_map_e, width = 20, height = 20)
```

...
map1 <- ggplot(map1_data, aes(x = long, y = lat, group = group)) +
  ...
  scale_fill_gradient(name = 'Nr. of jobs', low = 'yellow', high = 'red', na.value = 'grey' ,limits = c(0, 500)) +
  labs(tag = paste0("**Cluster 1: Offshore and**<br>**Energy engineering**",
                    "(n jobs = ",
...
map4 <- ggplot(map2_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Nr. of Jobs', low = 'yellow', high = 'red', na.value = 'grey' ,limits = c(0, 500)) +
  labs(tag = paste0("**Cluster 4: Innovation and**<br>**Research** <br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot),
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
map3 <- ggplot(map3_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Nr. of Jobs', low = 'yellow', high = 'red', na.value = 'grey',limits = c(0, 500) ) +
  labs(tag = paste0("**Cluster 3: Energy Utilities**<br> <br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
map2 <- ggplot(map4_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Nr. of Jobs', low = 'yellow', high = 'red', na.value = 'grey',limits = c(0, 500) ) +
  labs(tag = paste0("**Cluster 4: Industrial Engineering** <br> **and Consulting","(n jobs = ",
...
map6 <- ggplot(map5_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Nr. of Jobs', low = 'yellow', high = 'red', na.value = 'grey',limits = c(0, 500) ) +
  labs(tag = paste0("**Cluster 6: Generic Engineering**<br> **and Research**<br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
map5 <- ggplot(map6_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Nr. of Jobs', 
                      low = 'yellow', 
                      high = 'red',
                      na.value = 'grey',
                      limits = c(0, 500)) +
  labs(tag = paste0("**Cluster 5: Across Industries**<br> <br>","(n jobs = ",
                    as.character(round(n_cluster)),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",

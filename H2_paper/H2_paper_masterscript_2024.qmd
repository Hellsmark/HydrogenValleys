...
for (i in 1:length(seeds_5)){
  seed <- seeds_5[i]
  cluster_result_k5 <- readRDS(paste0('H2_paper/cluster_new/k=5/all_seeds/',
  ...
  k_mean_plot
  ggsave(paste0("H2_paper/cluster_new/k=5/best_result/k-mean_plot_",
                as.character(seed),".png"))
...
```{r}
seeds_6 <- c(4616,8716,8389,6829,4581,5012,8789)
...
for (i in 1:length(seeds_6)){
  ...
  make_table_function_new(cluster_result_k6,6,5) #Last number is for top percentage, written in percentage and not decimals
}
```
...
```{r}
seeds_4_combo <- c(9287,5717,9898)
...
for (i in 1:length(seeds_6_combo)){
  ...
  make_table_function_new_combo(cluster_result_k6_combo,6,5) #Last number is for top percentage, written in percentage and not decimals
}
```
...
map1 <- ggplot(map1_data, aes(x = long, y = lat, group = group)) +
  ...
  scale_fill_gradient(name = 'Job concentration of cluster', low = 'yellow', high = 'red', na.value = 'grey' ,limits = c(0, 500)) +
  labs(tag = paste0("**Cluster 1: General industry** (n jobs = ",as.character(n_cluster),
                    ', ',as.character(share_cluster_tot), '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
    plot.tag = element_markdown(hjust = 0.5, size = 14),
...
ggsave(filename = paste0("H2_paper/cluster_new/unified_oslo/k=6",
                  '/best_result/',as.character(5980),"_map1.png"),
           plot = map1)
```
...
map2 <- ggplot(map2_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Job concentration of cluster', low = 'yellow', high = 'red', na.value = 'grey' ,limits = c(0, 500)) +
  labs(tag = paste0("**Cluster 2: Management & Finance in Oslo & Copenhagen** (n jobs = ",
                    as.character(n_cluster),', ',as.character(share_cluster_tot),
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
    plot.tag = element_markdown(hjust = 0.5, size = 14),
...
ggsave(filename = paste0("H2_paper/cluster_new/unified_oslo/k=6",
                  '/best_result/',as.character(5980),"_map2.png"),
           plot = map2)
```
...
map3 <- ggplot(map3_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Job concentration of cluster', low = 'yellow', high = 'red', na.value = 'grey',limits = c(0, 500) ) +
  labs(tag = paste0("**Cluster 3: Energy Engineering on Norwegian coast** (n jobs = ",
                    as.character(n_cluster),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
ggsave(filename = paste0("H2_paper/cluster_new/unified_oslo/k=6",
                  '/best_result/',as.character(5980),"_map3.png"),
           plot = map3)
```
...
map4 <- ggplot(map4_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Job concentration of cluster', low = 'yellow', high = 'red', na.value = 'grey',limits = c(0, 500) ) +
  labs(tag = paste0("**Cluster 4: Other** (n jobs = ",as.character(n_cluster),', ',
                    as.character(share_cluster_tot), '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
    plot.tag = element_markdown(hjust = 0.5, size = 14),
...
ggsave(filename = paste0("H2_paper/cluster_new/unified_oslo/k=6",
                  '/best_result/',as.character(5980),"_map4.png"),
           plot = map4)
```
...
map5 <- ggplot(map5_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Job concentration of cluster', low = 'yellow', high = 'red', na.value = 'grey',limits = c(0, 500) ) +
  labs(tag = paste0("**Cluster 5: Energy Engineering around Oslo** (n jobs = ",
                    as.character(n_cluster),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
ggsave(filename = paste0("H2_paper/cluster_new/unified_oslo/k=6",
                  '/best_result/',as.character(5980),"_map5.png"),
           plot = map5)
```
...
map6 <- ggplot(map6_data, aes(x = long, y = lat, group = group)) +
  geom_polygon(aes(fill = n_place_cluster), color = 'black') +
  scale_fill_gradient(name = 'Job concentration of cluster', 
                      low = 'yellow', 
                      high = 'red',
                      na.value = 'grey',
                      limits = c(0, 500)) +
  labs(tag = paste0("**Cluster 6: Universities & Research institutes** (n jobs = ",
                    as.character(n_cluster),', ',as.character(share_cluster_tot), 
                    '% of all jobs)')) +
  theme(
    plot.tag.position = "bottom",
...
ggsave(filename = paste0("H2_paper/cluster_new/unified_oslo/k=6",
                  '/best_result/',as.character(5980),"_map6.png"),
           plot = map6)
```

...
gc_jobs %>% ggraph(layout = "nicely") + 
  ...
  geom_node_label(aes(label = 
                        ifelse(
                          (type == "comp" & (degree > 1 | n >= sum(comp_n$n)*.01)) |
  ...
  labs(title = "Actors Cutting Across the Nordic countries or recruiting at large within countries", 
       caption = "Most central actors cutting across multiple countries, as well as actors recruiting within single countries accounting for 1% or more of all jobs found.")+

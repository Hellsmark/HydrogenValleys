...
regions_noJobs <- data.frame(
  ...
  place = c("NO, Innlandet", "SE, Blekinge", "SE, Jönköping", "SE, Örebro"),
  n = c(0,0,0,0))
...
gdp_jobs_plot <- regional_GDP %>% 
  ...
  annotate("text", x=94, y =228, label = r2_p_gdp_no)+
...
cluster_function <- function(matrx,k){
  ...
  png(paste0("figs/k-mean_",as.character(k),".png"), width = 800, height = 600)
  autoplot(KM,matrx,frame=TRUE)
  dev.off()
